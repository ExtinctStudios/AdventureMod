...
public class ModPlacedFeatures {
    public static final RegistryKey<PlacedFeature> BLOODSTONE = registerKey("bloodstone");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context){
        ...
        register(
                ...
                ModOrePlacement.modifiersWithCount(12, HeightRangePlacementModifier.trapezoid(YOffset.fixed(-42), YOffset.fixed(67)))
        );
        ...
        register(
                ...
                ModOrePlacement.modifiersWithCount(12, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(74)))
        );
    }
